...
# Github repo
issues_github_path = "cocotb/cocotb-bus"
...
release = cocotb_bus.__version__
...
htmlhelp_basename = "cocotb_bus_doc"
...
in_progress_notes = subprocess.check_output(
    ["towncrier", "--draft", "--name", "cocotb_bus", "--version", release],
    cwd="../..",
...
extlinks = {
    ...
    "reposharp": ("https://github.com/cocotb/cocotb-bus/issues/%s", "#"),
    "reposrc": ("https://github.com/cocotb/cocotb-bus/blob/master/%s", None),
}
